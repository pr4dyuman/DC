...
export async function sendAdminNotificationEmail(formData) {
  ...
  const adminEmail = process.env.ADMIN_EMAIL || process.env.BREVO_SENDER_EMAIL || "ankitmaharshi55@gmail.com";

  const sendSmtpEmail = {
    subject: `New Contact Form Submission from ${fullName}`,
    to: [{ email: adminEmail, name: "Admin" }],
    sender: {
      name: "Digital Corvids Website",
      email: process.env.BREVO_SENDER_EMAIL || "ankitmaharshi55@gmail.com",
    },
    htmlContent: `
    <!DOCTYPE html>
    <html>
