    ...
    },
    {
        ...
        parameters: {
            ...
            properties: {
                ...
                assigneeId: { type: "STRING", description: "[Backward compatible] First user ID to assign the task to - look up from the QUICK LOOKUP TABLE. Leave empty to auto-assign to least busy person." },
                assigneeIds: { type: "ARRAY", items: { type: "STRING" }, description: "All user IDs to assign this task to when multiple people are responsible. Keep assigneeId as the first ID if also provided." },
    ...
    },
    {
        ...
        parameters: {
            ...
            properties: {
                ...
                assigneeId: { type: "STRING", description: "[Backward compatible] The first new assignee's user ID - look up from the QUICK LOOKUP TABLE" },
                assigneeIds: { type: "ARRAY", items: { type: "STRING" }, description: "All user IDs that should be assigned to this task" },
            },
            required: ["taskId"],
        },
    },
                ...
                tasks: {
                    ...
                    items: {
                        ...
                        properties: {
                            ...
                            assigneeId: { type: "STRING", description: "[Backward compatible] First user ID from the QUICK LOOKUP TABLE" },
                            assigneeIds: { type: "ARRAY", items: { type: "STRING" }, description: "All user IDs to assign this task to when multiple people are responsible" },
