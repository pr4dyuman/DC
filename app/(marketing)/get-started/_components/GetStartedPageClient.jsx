...
import GetStartedFeaturesSection from "./GetStartedFeaturesSection";
import GetStartedAISpotlight from "./GetStartedAISpotlight";
import GetStartedStepsSection from "./GetStartedStepsSection";
import GetStartedSignupForm from "./GetStartedSignupForm";

export default function GetStartedPageClient({
    directAuthMode = false,
    isAIBloggerFlow = false,
}) {
    ...
    if (directAuthMode) {
        return (
            <section className="relative overflow-hidden py-12 text-white font-glacial sm:py-16 lg:py-20">
                {!authChecked && (
                    <div className="fixed inset-0 z-50 flex min-h-screen items-center justify-center bg-black text-white font-glacial">
                        <div className="h-6 w-6 animate-spin rounded-full border-2 border-[#F5EE30] border-t-transparent" />
                    </div>
                )}
    ...
    return (
        <div className="relative bg-black text-white font-glacial">
            {!authChecked && (
                <div className="fixed inset-0 z-50 flex min-h-screen items-center justify-center bg-black text-white font-glacial">
                    <div className="h-6 w-6 animate-spin rounded-full border-2 border-[#F5EE30] border-t-transparent" />
                </div>
