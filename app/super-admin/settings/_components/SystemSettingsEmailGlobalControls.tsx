        ...
        <>
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                    <span className="text-sm font-medium text-foreground">Agency Notification Email Service</span>
            ...
            {!emailGlobalEnabled && (
                <div className="border border-red-500/20 bg-red-500/5 rounded-lg p-3 flex items-start gap-2">
                    ...
                    <div className="text-xs text-red-400">
                        <strong>Agency notification emails disabled.</strong> Account/auth and contact form emails are controlled by the permissions below.
                    </div>
                </div>
            )}
            ...
            {emailGlobalEnabled && (
                <div className="border border-amber-500/20 bg-amber-500/5 rounded-lg p-3 flex items-start gap-2">
                    ...
                    <div className="text-xs text-amber-200/80">
                        <strong>Brevo Free Tier:</strong> 300 emails/day. Agency notification categories below can be tuned separately from account/auth and contact form emails.
                    </div>
                </div>
            )}
        </>
