...
import { useChatPanelState } from "@/components/chat/useChatPanelState";
            ...
            >
                ...
                <div className={`w-full md:w-80 border-r border-border flex flex-col bg-secondary ${mobileView === 'chat' ? 'hidden md:flex' : 'flex'}`}>
                    ...
                    <div className="p-4 pt-2 space-y-3">
                        ...
                        >
                            {viewMode === 'chats' ? (<><MessageCircle className="w-4 h-4 mr-2" />New Message</>) : (<><X className="w-4 h-4 mr-2" />Cancel Selection</>)}
                        </button>
                    </div>
