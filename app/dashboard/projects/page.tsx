...
import { getProjects, getServices, getCurrentUser, getAllProjectTasks, getUsers } from "@/lib/actions";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Loader2, Plus, Search, AlertCircle, LayoutGrid, List } from "lucide-react";
...
export default function ProjectsPage() {
    ...
    const loadData = async () => {
        const [p, s, u, tasks, users] = await Promise.all([
            getProjects(),
            getServices(),
            getCurrentUser(),
            getAllProjectTasks(),
    ...
    return (
        <div className="space-y-5">
            ...
            <CreateProjectWizard open={showWizard} onOpenChange={setShowWizard} onProjectCreated={loadData} />
