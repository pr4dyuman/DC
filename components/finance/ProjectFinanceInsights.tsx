...
interface ProjectFinanceInsightsProps {
...
export function ProjectFinanceInsights({
    totalMonthlyRate,
    excessPayment,
    monthsCovered,
    displayBudget,
                    ...
                    <CardContent className="space-y-3">
                        {recentTransactions.map((transaction) => (
                            <div key={transaction.id} className="flex items-center gap-3">
                                <div className={`p-1.5 rounded-full ${transaction.type === "income" ? "bg-emerald-500/10" : "bg-red-500/10"}`}>
