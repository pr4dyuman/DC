        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12">
          ...
          <div className="flex flex-col max-w-md">
            ...
            <div className="flex gap-6">
              <a href="https://www.instagram.com/digitalcorvids?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" aria-label="Digital Corvids on Instagram" className="text-white hover:text-gray-300 transition-colors"><Instagram size={24} aria-hidden="true" /></a>
              <a href="https://wa.me/918003177679" target="_blank" rel="noopener noreferrer" aria-label="Chat with Digital Corvids on WhatsApp" className="text-white hover:text-gray-300 transition-colors">
              ...
              <a href="https://www.linkedin.com/in/digital-corvids-681389306" target="_blank" rel="noopener noreferrer" aria-label="Digital Corvids on LinkedIn" className="text-white hover:text-gray-300 transition-colors"><Linkedin size={24} aria-hidden="true" /></a>
            </div>
          </div>
